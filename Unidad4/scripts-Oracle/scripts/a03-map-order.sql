...
-- ACTIVIDAD: 
--*Crea los tipos EMPLEADO, DEPARTAMENTO, DIRECCION, PROYECTOS que tengan sus constructores, getters y setters
...
DECLARE
    DIR1 DIRECCION := DIRECCION('Calle 1', '02', '51002', 'Ceuta'); 
    EMP1 EMPLEADO := EMPLEADO('Pedro', 'Gonzalez Fernandez', 2500, DIR1);
BEGIN
    DBMS_OUTPUT.PUT_LINE(EMP1.GET_DIR().GET_CALLE());
END;
/
