...
public class ManageEmployee {
  ...
  public static void main(String[] args) {
    ...
    HashMap<String, Certificate> set1 = new HashMap<>();
  ...
  public Integer addEmployee(String fname, String lname, int salary, Map<String, Certificate> cert) {
  ...
  public void listEmployees() {
    ...
    try {
      ...
      for (Iterator<Employee> iterator = employees.iterator(); iterator.hasNext();) {
        ...
        Map<String, Certificate> ec = employee.getCertificates();
