package company.main.collectionsmappings.e_bag_one_to_many;
...
import company.entity.collectionsmappings.e_bag_one_to_many.*;
...
public class ManageEmployee {
  ...
  public static void main(String[] args) {
    ...
    ArrayList<Certificate> set1 = new ArrayList<>();
    ...
    ArrayList<Certificate> set2 = new ArrayList<>();
  ...
  public Integer addEmployee(String fname, String lname, int salary, Collection<Certificate> cert) {
  ...
  public void listEmployees() {
    ...
    try {
      ...
      for (Iterator<Employee> iterator = employees.iterator(); iterator.hasNext();) {
        ...
        //-----Iterate over the Collection of Certificates of Employe i--------
