package company.main.collectionsmappings.c_sortedset_one_to_many;

import java.util.List;
import java.util.Iterator;
import java.util.SortedSet; //<-------------SortedSet
...
import company.entity.collectionsmappings.c_sortedset_one_to_many.*;
...
public class ManageEmployee {
  ...
  public static void main(String[] args) {
    ...
    TreeSet<Certificate> set1 = new TreeSet<>();
    ...
    TreeSet<Certificate> set2 = new TreeSet<>();
  ...
  /* Method to add an employee record in the database */ //SortedSet
  public Integer addEmployee(String fname, String lname, int salary, SortedSet<Certificate> cert) {
    ...
    try {
      ...
      employee.setCertificates(cert);//<----------------------SortedSet
