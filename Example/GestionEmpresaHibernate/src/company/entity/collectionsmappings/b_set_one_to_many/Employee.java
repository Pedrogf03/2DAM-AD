package company.entity.collectionsmappings.b_set_one_to_many;

import java.util.Set;

/**
 * <h3>Set and one-to-many</h3>
...
public class Employee {
  ...
  private int salary;
  private Set<Certificate> certificates; //<---one-to-many: one Employee many Certificates
