...
public class GestionEmpleados {
  ...
  static String urlFolder = "c:/Users/bleik/Desktop/sqlite";
  ...
  static String user = "root"; //static String user="user";
  static String password = "123456"; //static String password="password";
